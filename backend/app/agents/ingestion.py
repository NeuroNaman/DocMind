...
#         Returns:
#             State updates with ingestion results
#         """
...
#                 return {"next_agent": "planner_agent", "chunks_added": 0}
...
#             # This ensures each upload session starts fresh
#             if chunks:
...
#                 try:
#                     vector_store.clear()
#                     self.logger.info("Cleared existing vector store for fresh upload")
#                 except Exception as e:
#                     self.logger.warning(f"Could not clear vector store: {e}")
...
#             return {"error": str(e), "next_agent": "planner_agent", "chunks_added": 0}
#         except Exception as e:
