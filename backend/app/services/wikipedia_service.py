...
#     Used as fallback when document context is not available.
#     """
...
#             logger.error(f"Failed to initialize Wikipedia: {e}")
#             raise
...
#         Returns:
#             Wikipedia search results as string
#         """
#         try:
#             result = self._wikipedia.run(query)
#             logger.info(f"Wikipedia search completed for: {query[:50]}...")
#             return result
#         except Exception as e:
...
#     """Get the global Wikipedia service instance."""
